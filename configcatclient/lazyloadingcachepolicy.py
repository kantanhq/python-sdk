...
class LazyLoadingCachePolicy(CachePolicy):
    def __init__(self, config_fetcher, config_cache, cache_time_to_live_seconds=60):
        ...
        self._cache_time_to_live = datetime.timedelta(
            seconds=cache_time_to_live_seconds
        )
    ...
    def get(self):
        ...
        try:
            ...
            if (
                self._last_updated is not None
                and self._last_updated + self._cache_time_to_live > utc_now
            ):
        ...
        try:
            ...
            if (
                ...
                or self._last_updated + self._cache_time_to_live
